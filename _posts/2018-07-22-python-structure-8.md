...
Collection 은 수집, 모음 이라는 뜻입니다. Python에서 Collection은 여러 개의 값들을 수집할 수 있는 자료 구조를 말합니다. 리스트, 딕셔너리, 튜플이 collection에 해당합니다.  

우리가 알고 있는 변수와 collection과의 차이에 대해 간단히 살펴보도록 하겠습니다.
...
collection을 이용하면 값을 단순히 수집하는것 이외에 다양한 방법으로 데이터를 처리할 수 있습니다. 오늘은 collection 중 리스트에 대해 알아보고 활용 방법들에 대해 살펴보도록 하겠습니다.
...
- 리스트는 대괄호로 둘러싸여 있고, 리스트 원소는 반점으로 구분됩니다.
...
- 순서를 바꾸기 위해 별도의 행동을 하지 않는 한 아이템의 순서를 유지합니다.
- 리스트는 원소 정렬이 가능합니다.
...
![스크린샷 2018-07-22 오후 8.50.22](https://i.imgur.com/XL0fFWF.png)
