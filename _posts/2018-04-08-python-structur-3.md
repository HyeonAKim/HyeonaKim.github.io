...
영어 단어와 문법을 배우고 문장을 만들어 외국인과 의사소통을 하지요.
마찬가지로 python의 단어와 문법을 배우고, 문장을 만들어 컴퓨터와 의사소통할 수 있습니다.
...
그럼 이제 파이썬 프로그래머가 되기 위해서 파이썬의 단어와 글쓰는 방법에 대해 공부하려 합니다.

### 2. 파이썬 단어

#### 2-1. 예약어
파이썬이라는 강아지가 있다고 생각해 봅시다.
우리가 파이썬은 앉아, 일어서, 밥, 간식 이런 단어들을 훈련하기 전에 이미 알고 태어났습니다.
...
우리가 문장을 사용해서 문단을 만들고 논리적인 글을 쓸 때
글 전체가 전달하고자 하는 의미,
문단이 전달하고자 하는 의미,
문단 간의 조화가 어떻게 이뤄질지,
...
조건이 2개 이상일 경우 if 문을 2번 사용해도 가능하시만 **elif** 예약어 사용도 가능합니다.
```python
if 조건1:
  조건1이 참인 경우1
elif 조건2:
...
어떻게 원하는 만큼 반복하는지 예제를 통해 알아 보겠습니다.
